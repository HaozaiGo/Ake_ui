 ...
 * @Author: 
 * @Description: 
 * @Date: 2022-01-19 14:48:27
 * @LastEditTime: 2022-04-26 14:17:09
 * @FilePath: \Water-Marketing-System\src\config\settings.js
 */
/**
...
module.exports = {
  ...
  routerMode: "history",
  //不经过token校验的路由
  routesWhiteList: ["/login", "/register", "/404", "/401", "/API"],
  //加载时显示文字
  loadingText: "正在加载中...",
  //token名称
  tokenName: "token",
